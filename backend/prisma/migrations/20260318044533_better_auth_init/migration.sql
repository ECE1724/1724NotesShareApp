...
-- DropForeignKey
ALTER TABLE "FileAccess" DROP CONSTRAINT "FileAccess_userId_fkey";

-- DropForeignKey
ALTER TABLE "FileItem" DROP CONSTRAINT "FileItem_ownerId_fkey";

-- AlterTable
ALTER TABLE "Annotation" ALTER COLUMN "authorId" SET DATA TYPE TEXT;
...
-- AlterTable
ALTER TABLE "FileItem" ALTER COLUMN "ownerId" SET DATA TYPE TEXT;
